                ...
                >
                    ...
                    <div className="mb-6 border-b border-gray-100 pb-4">
                        <div className="flex justify-between items-start">
                            <div>
                                <h2 className="text-2xl font-bold text-[var(--color-secondary)]">Order #{order.id}</h2>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg text-sm">
                                    <p className="capitalize">{order.paymentMethod === 'cod' ? 'Cash on Delivery' : 'UPI Payment'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
